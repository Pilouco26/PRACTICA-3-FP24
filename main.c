...
void iniciar_taula_adalt(int taula[10][10], int taula1[10][10], int max_c, int max_f )
{
...
int main()
{
    int taula[10][10], taula1[10][10], borde_esquerra[10][1], resposta, encerts, errors, max_errors, max_f, max_c, fila, columna;
